              ...
              <React.Fragment key={step.id}>
                {index > 0 && (
                  <div className={`flex-1 h-0.5 mx-2 transition-all duration-500 ${
                    currentStep > index ? 'bg-indigo-500' : 'bg-slate-800'
                  }`} />
                )}
                <div className="flex flex-col items-center">
                  <button
                    ...
                    className={`w-10 h-10 rounded-full flex items-center justify-center border font-semibold text-sm transition-all duration-300
                      ${isCompleted 
                        ? 'bg-indigo-500 border-indigo-500 text-white' 
                        : isActive
                          ? 'bg-slate-900 border-indigo-500 text-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.2)]'
                          : 'bg-slate-950 border-slate-800 text-slate-500'
                      }`}
                  >
                    {isCompleted ? <Check className="w-5 h-5" /> : step.id}
                  </button>
                  <span className={`text-[10px] mt-2 font-medium tracking-wider uppercase transition-colors duration-300 hidden sm:block ${
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        {...register('email')}
                        readOnly
                        className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-800 bg-slate-950/20 text-slate-500 placeholder-slate-700 cursor-not-allowed outline-none text-sm"
                        placeholder="verified.user@gmail.com"
                      />
                    </div>
            ...
            {currentStep === 3 && (
              <div className="space-y-5 animate-in fade-in slide-in-from-right-3 duration-300">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <select
                      id="position"
                      {...register('position')}
                      className="w-full pl-10 pr-10 py-3.5 rounded-xl border border-slate-800 bg-slate-950/60 focus:bg-slate-950/90 text-slate-200 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm appearance-none cursor-pointer"
                    >
                ...
                <div className="p-4 rounded-xl border border-slate-800 bg-slate-950/20 text-xs text-slate-400 leading-relaxed flex gap-3">
              ...
              <div className="space-y-5 animate-in fade-in slide-in-from-right-3 duration-300">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-800 bg-slate-950/60 focus:bg-slate-950/90 text-slate-200 placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm"
                    placeholder="e.g. 3"
                    min="0"
                  />
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-800 bg-slate-950/60 focus:bg-slate-950/90 text-slate-200 placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm resize-y"
