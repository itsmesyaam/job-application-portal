      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed inset-y-0 right-0 z-50 w-full max-w-lg bg-slate-900 border-l border-slate-800 shadow-2xl flex flex-col"
          >
            {/* Drawer Header */}
              ...
              <div className="flex items-center justify-between">
                <div>
                  <motion.span 
                    ...
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-semibold border ${statusColors} mb-1.5`}
                  >
                    {candidate.status}
                  </motion.span>
              ...
              {activeTab === 'info' && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between p-4 rounded-xl border border-slate-855 bg-slate-955/30">
                  ...
                  <div className="border-t border-slate-855 pt-5 space-y-3">
                        ...
                        <div className="bg-slate-955/40 border border-slate-855 rounded-xl p-4 space-y-4">
                          ...
                          {task.status === 'SUBMITTED' && (
                            <div className="border-t border-slate-900 pt-3 flex items-center justify-end gap-2">
                              ...
                              >
                                {reviewingTask === 'REJECTED' && <Loader2 className="w-3.5 h-3.5 animate-spin" />}
                                Reject Submission
                              </motion.button>
                              <motion.button
                                whileHover={{ scale: 1.02 }}
                              ...
                              >
                                {reviewingTask === 'ACCEPTED' && <Loader2 className="w-3.5 h-3.5 animate-spin" />}
                                Accept & Pass
                              </motion.button>
                            </div>
                          )}
